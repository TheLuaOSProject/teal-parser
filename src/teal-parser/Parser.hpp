...
namespace teal::parser
{
    ...
    private:
        ...
        std::optional<UnionSlice<ast::LabelStatement>> parse_label();
        std::optional<UnionSlice<ast::IfStatement>> parse_if();
        std::optional<UnionSlice<ast::WhileStatement>> parse_while();
        std::optional<UnionSlice<ast::RepeatStatement>> parse_repeat();
        std::optional<UnionSlice<ast::ForInStatement, ast::ForNumericStatement>> parse_for();
        std::optional<UnionSlice<ast::DoStatement>> parse_do();
        std::optional<UnionSlice<ast::FunctionDeclarationStatement>> parse_function_decl(ast::Visibility vis, bool is_macroexp = false);
        UnionSlice<ast::VariableDeclarationStatement> parse_var_decl(ast::Visibility vis);
        std::optional<UnionSlice<ast::RecordDeclarationStatement>> parse_record_decl(ast::Visibility vis, bool is_interface);
        std::optional<UnionSlice<ast::EnumDeclarationStatement>> parse_enum_decl(ast::Visibility vis);
        std::optional<UnionSlice<ast::TypeAliasStatement>> parse_type_alias_decl(ast::Visibility vis);
        ...
        std::optional<UnionSliceOf_t<ast::PrimaryExpression, Union<ast::UnaryOperationExpression>>> parse_unary_expression();
        ast::Expression parse_exp_rec(int min_prec);
        ...
        std::optional<ast::Type> parse_base_type();
        std::optional<UnionSlice<ast::NominalType>> parse_nominal_type();
        std::optional<UnionSlice<ast::FunctionType>> parse_function_type();
