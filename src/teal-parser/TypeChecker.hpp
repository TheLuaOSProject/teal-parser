...
namespace teal::parser::typecheck
{
    ...
    class TypeChecker {
        ...
        private:
            ...
            void declareType(teal::parser::ast::RecordDeclarationStatement *node, std::shared_ptr<TypeSymbol> parent = nullptr);
            void declareType(teal::parser::ast::EnumDeclarationStatement *node, std::shared_ptr<TypeSymbol> parent = nullptr);
            ...
            TypePtr resolveTypeNode(teal::parser::ast::TypeNode *typeNode, std::shared_ptr<TypeSymbol> currentTypeSym = nullptr);
            std::shared_ptr<TypeSymbol> findTypeSymbol(const std::vector<std::string> &nameParts);
            struct NarrowInfo { TypePtr thenType; TypePtr elseType; };
